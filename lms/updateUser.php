...
<body>
  ...
  <?php 
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "UPDATE users SET `username`='$username', `email`='$email', `password`='$password', `image`='$imagePath' WHERE id=$id";
        $result = mysqli_query($connect, $query);

        if($result){
          set_message('User was updated successfully!', 'success');
        ...
        <div class="col-md-6">
          <form action="updateUser.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" name="username" aria-describedby="username" value="<?php echo $user['username']; ?>" >
            <div class="mb-3">
